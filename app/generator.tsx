...
/* ------------------------------------------------------------------ */
/* Slider sous-groupe (port SgSliderRow) — drag natif via Gesture.Pan  */
/* ------------------------------------------------------------------ */
function SgSliderRow({ name, pct, series, onChange }: { name: string; pct: number; series: number; onChange: (v: number) => void }) {
